...
export default function Membership() {
  ...
  return (
    <section
      ref={ref}
      className="relative w-full bg-gradient-to-b from-[#FFFFFF] to-[#1E6A9F] text-black py-16 overflow-hidden"
    >
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between px-6 lg:px-20">
        ...
        >
          ...
          <p className="text-[#6F7787] font-normal text-lg lg:mt-[104px]">
            In qui aliquip enim sunt amet et eu sunt excepteur reprehenderit
            anim officia esse adipiscing.
          </p>
