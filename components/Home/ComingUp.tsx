...
export default function ComingUp() {
  return (
    <div className="w-full mx-auto bg-gradient-to-b from-[#1E6A9F] to-[#FFFFFF] text-black pt-[96px]">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between px-6 lg:pb-[200px]">
        {/* Left Content */}
        <motion.div
        ...
        >
          ...
          >
            <span className="text-[#6355D8] text-lg font-normal">View More</span>
          </motion.button>
        </motion.div>
